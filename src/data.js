...
export const feedPosts = [
  ...
  },
  {
    ...
    time: "6 hours ago",
    premium: true,
    body: ["Exploring the untouched beauty of Himachal! 🏔️"],
...
export const conversations = [
  ...
  { name: "Meera Art", time: "30m", last: "Your message was so kind 🙏", unread: 1, online: true, verified: true },
  { name: "Fit With Neha", time: "1h", last: "See you in the live session!", online: true, verified: true },
  { name: "Wander With Karan", time: "2h", last: "Loved your question!", verified: true },
  { name: "Creator Squad", time: "3h", last: "Rohit: New upload tomorrow 🔥", unread: 3, group: true },
  { name: "Arjun Fitness", time: "5h", last: "Shared a post" },
  { name: "Pooja Singh", time: "1d", last: "Thank you so much! 😊" },
