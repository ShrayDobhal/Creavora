      ...
      <section className="relative overflow-hidden px-5 pb-16 pt-8 sm:px-8 sm:pt-14">
        <div className="mx-auto grid max-w-[1500px] items-start gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          <div className="animate-fade-up pt-6">
            <span className="inline-flex items-center gap-2 rounded-full border border-brand-200 bg-brand-50 px-4 py-2 text-[13px] font-bold text-brand-700 shadow-sm">
              <Sparkles size={14} className="fill-brand-500 text-brand-500" />
              The Premium Creator Platform
            </span>

            <h1 className="mt-7 text-5xl font-extrabold leading-[1.04] tracking-[-0.045em] sm:text-6xl xl:text-[68px]">
              Support Your
              <br />
              Favorite Creators.
              <br />
            ...
            <div className="mt-9 flex flex-wrap items-center gap-4">
              <Link href="/explore"
                className="group flex h-[58px] items-center gap-3 rounded-full bg-brand-600 pl-8 pr-3 text-[16px] font-bold text-white shadow-[0_18px_34px_-14px_rgba(107,63,239,.8)] transition hover:-translate-y-0.5 hover:bg-brand-700"
              >
                Explore Creators
          ...
          <div className="relative mt-6 h-[520px] overflow-hidden rounded-[2rem] bg-[#171126] shadow-[0_35px_70px_-28px_rgba(52,24,112,.55)] lg:mt-0 lg:h-[560px]">
            <Image
              src="/images/creator-collective-hero.png"
              alt="A collective of creators in a modern content studio"
              fill
              priority
              sizes="(max-width: 1024px) 100vw, 50vw"
              className="object-cover object-center transition duration-700 hover:scale-[1.025]"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#12091f]/50 via-transparent to-[#190729]/20" />
            <div className="absolute inset-x-0 bottom-0 h-2/5 bg-gradient-to-t from-[#110b1d]/70 to-transparent" />
            <CollageCard
              name="Rohit Gamer"
              role="Gaming"
              seed="rohit-stream"
              className="animate-float absolute left-[2%] top-[6%] h-[200px] w-[215px] -rotate-6 border border-white/20"
            />
            <CollageCard
              name="Arjun Fitness"
              role="Fitness Coach"
              seed="arjun-gym"
              className="animate-float-delayed absolute right-[6%] top-[4%] h-[210px] w-[215px] rotate-3 border border-white/20"
            />
            <CollageCard
              name="Meera Art"
              role="Artist"
              seed="meera-studio"
              className="animate-float-delayed absolute left-[4%] top-[46%] h-[210px] w-[210px] -rotate-3 border border-white/20"
            />
            <CollageCard
              name="Wander With Karan"
              role="Travel Creator"
              seed="karan-himachal"
              className="animate-float absolute right-[3%] top-[45%] h-[212px] w-[215px] rotate-2 border border-white/20"
            />
