  ...
  return (
    <div className="min-h-full bg-white">
      <header className="sticky top-0 z-30 flex h-[72px] items-center gap-8 border-b border-line bg-white px-8">
        <Link to="/" className="flex items-center gap-2.5" title="Enter the app">
        ...
        <div className="ml-auto flex items-center gap-6">
          ...
          <Link to="/studio" className="text-[14px] font-bold hover:text-brand-600">
            Become a Creator
          </Link>
      ...
      <section className="px-8 py-12">
        <div className="mx-auto max-w-[1500px]">
          ...
          <div className="mt-7 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            {topCreators.map((c) => (
              <Link key={c.name} to={`/creator/${slug(c.name)}`}>
