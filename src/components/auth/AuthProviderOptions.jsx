...
export default function AuthProviderOptions({ role, redirect, dark = false }) {
  ...
  useEffect(() => {
    ...
    fetch("/api/auth/providers", { cache: "no-store" })
      ...
      .then((data) => { if (active) setProviders({ google: data.google === true, passwordReset: data.passwordReset === true }); })
      .catch(() => {})
  ...
  return (
    <div className="mt-5 space-y-3">
      <div className={`flex items-center gap-3 text-[12px] ${dark ? "text-neutral-500" : "text-muted"}`}>
